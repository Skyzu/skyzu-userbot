...
async def killdabot(event):
    ...
    await event.edit("**Mematikan Levin-Userbot....**")
...
async def killdabot(event):
    await event.edit("**Restarting Levin-Userbot...**")
...
async def reedme(e):
    await e.edit(
        ...
        "\n[⚡ lepin-UserBot Repo](https://github.com/LevinSkuy/LEVIN-USERBOT/blob/lepin-userBot/README.md)"
