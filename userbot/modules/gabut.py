...
async def typewriter(typew):
    typew.pattern_match.group(1)
    await typew.edit("☑️ `synon own wibu`")
    sleep(2)
    await typew.edit("✅ `synon own wibu`")
    sleep(1)
    await typew.edit("☑️ `dinn stres`")
    sleep(2)
    await typew.edit("✅ `dinn stres`")
    sleep(1)
    await typew.edit("☑️ `audy Gajelas`")
    sleep(2)
    await typew.edit("✅ `audy Gajelas`")
    sleep(1)
    await typew.edit("☑️ `shout Wibu Sangean`")
    sleep(2)
    await typew.edit("✅ `shout Wibu Sangean`")
    sleep(1)
    await typew.edit("☑️ `shina Autis`")
    sleep(2)
    await typew.edit("✅ `shina Autis`")
    sleep(1)
