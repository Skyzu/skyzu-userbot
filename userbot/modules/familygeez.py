...
@register(outgoing=True, pattern='^Audy(?: |$)(.*)')
async def typewriter(typew):
    typew.pattern_match.group(1)
    sleep(1)
    await typew.edit("**audy**")
    sleep(1)
    await typew.edit("**Audy cantik banget**")
    sleep(1)
    await typew.edit("**Boleh Aku minta pap anunya? **")
    sleep(1)
    await typew.edit("**Kan audy Mukanya Kaya Babi🙈**")
    sleep(1)
    await typew.edit("**Ehh Engga Deh,Audy Kan cantik banget Kaya Artis Korea😄**")
    sleep(1)
    await typew.edit("**Tapi Boong😂**")
    sleep(1)
    await typew.edit("**HAHAHAHAHAHAHA**")
    sleep(1)
    await typew.edit("**Udah Ahh Takut audy Nangis Minta Balon😂**")
    sleep(1)
    await typew.edit("**Pokoknya audy cantik Banget**")
    sleep(1)
    await typew.edit("**Tapi Bo'ong Hiyahiyahiya**")
# Create by myself @localheart
