...
PMPERMIT_PIC = os.environ.get(
    "PMPERMIT_PIC") or "https://telegra.ph/file/fd08937c4ae6cb1303731.jpg"
...
INLINE_PIC = os.environ.get(
    "INLINE_PIC") or "https://telegra.ph/file/fd08937c4ae6cb1303731.jpg"
...
with bot:
    try:
        ...
        LOGS.info(
            "Join Support Group @skyzusupport and Channel @ProjectSkyzu to see the updates of userbot"
            "Don't Leave")
        quit(1)
        ...
        async def opeen(event):
            try:
                ...
                if tgbotusername is not None:
                    results = await event.client.inline_query(tgbotusername, "@skyzuuserbot")
